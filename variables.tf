...
variable "ec2_role_name" {
  type        = string
  description = "(Required) Name of the role for EC2 instance profile."
}
...
variable "tfe_organisation" {
  type        = string
  description = "(Optional) Name of TFE Organisation"
}

variable "tfe_workspace" {
  type        = string
  description = "(Optional) Name of networking workspace to get information"
}
